...
namespace NUDTTK
{
	namespace Simu
	{
		...
		{ 			
			...
			double  noiseSigma_C1;         // C1 观测噪声大小[GPS]
		...
		public:
			...
			static bool judgeGPSSignalCover(POS3D posGPSSat, POS3D posRec, POS3D Vector_z, double cut_elevation = 10);
		...
		public:
			...
			POS3D                m_delPcoAnt;        // 接收机天线偏移偏差矢量，天线系
