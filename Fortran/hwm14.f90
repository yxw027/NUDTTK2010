...
!!!
!!! Output argument:
!!!        w(1) = meridional wind (m/sec + northward),径向，指向北方向
!!!        w(2) = zonal wind (m/sec + eastward),纬向，指向东方向
!!!
!!!================================================================================
...
module qwm
    ...
    character(128)             :: qwmdefault = 'astrodata\fortran\hwm123114.bin'
!    character(128)             :: qwmdefault = 'D:\NUDTTK\Fortran\hwm123114.bin'
...
module dwm
    ...
    character(128), parameter  :: dwmdefault = 'astrodata\fortran\dwm07b104i.dat'
!character(128), parameter  :: dwmdefault = 'D:\NUDTTK\Fortran\dwm07b104i.dat'
...
contains
    ...
    subroutine initgd2qd()
        ...
        character(128), parameter   :: datafile='astrodata\fortran\gd2qd.dat'
!        character(128), parameter   :: datafile='D:\NUDTTK\Fortran\gd2qd.dat'
